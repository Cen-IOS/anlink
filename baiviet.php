                                ...
                                <div class="card-block">
								 <div class="row mb-4">
								  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                    <img src="https://graph.facebook.com/<?php echo $idtao; ?>/picture?type=large&redirect=true&width=120&height=120" alt="" class="img-thumbnail" />
									</div><div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
									<p class="card-title"><i class="fa fa-user-circle-o"></i> Member Post : <a href="http://facebook.com/<?php echo $idtao; ?>"><?php echo ''.$Nguoitao.''; ?></a></p> 
									<p class="card-title"><i class="fa fa-times-circle-o" aria-hidden="true"></i> Time : <?php  echo facebook_time_ago($time); ?></p>
									<p class="card-text">Likes : <?php echo $TKLike;?> <i class="fa fa-heart text-danger" aria-hidden="true"></i> | Comments : <?php echo $TKBL;?> <i class="fa fa-comments text-danger" aria-hidden="true"></i></p>
									</div>
									</div><hr>
									<p class="card-text"><?php echo ''.$ten.''; ?></p>
									<hr>
									<div class>
									<a target="_blanks" href="<?php echo $linkbv;?>"><button class="btn btn-primary"><i class="fa fa-send"></i> Xem Bài Trên Facebook</button></a>
                                   </div>
								</div>
                            </div>
					</div>
