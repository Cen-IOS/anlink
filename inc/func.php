...
if(empty($accessToken)){
			...
			$db->exec("INSERT INTO `link` SET `FBID` = '".userID($_SESSION['facebook_access_token'])."',`Hash` = '$EncodeLink', `Password` = '{$_POST['pass']}', `Url` = '{$_POST['link']}', `SUrl` = '$GoogleShortUrl', `Time` = '".date("Y-m-d H:i:s")."'");
			}
		}
